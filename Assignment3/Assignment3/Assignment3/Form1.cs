    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            System.Diagnostics.Debug.WriteLine("Form1_Load() called..."); textBoxDisplay.Text = "Startup..."; try
            {
                ...
                var datasource = @"DESKTOP-1I404SC\SQLEXPRESS";
        ...
        private void buttonCountRecords_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-1I404SC\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True");
            connection.Open();
