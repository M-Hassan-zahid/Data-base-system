    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            richTextBox1.Text = "Startup..."; try
            {
                ...
                SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-1I404SC\SQLEXPRESS;Trusted_Connection=True;Initial Catalog=Northwind;Integrated Security=True");
                connection.Open();
